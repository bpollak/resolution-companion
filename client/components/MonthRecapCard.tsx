...
/**
 * Entry card for the "Monthly Progress" story, shown on Today during the first
  ...
  return (
    ...
    >
      ...
      <ThemedText style={styles.headline}>
        {recap.actionsCompleted} completed{" "}
        {recap.actionsCompleted === 1 ? "action" : "actions"} for{" "}
        {recap.personaName}
      </ThemedText>
      ...
      <Pressable
        ...
        accessibilityRole="button"
        accessibilityLabel="Open your Monthly Progress story"
