...
Speak to them as this person-in-progress. Frame feedback around what "${persona.name}" would do, and treat every completed action as evidence of becoming them. Reference this identity naturally (e.g. "the ${persona.name} you're building toward") but NEVER use the word "persona."
`
    : "";
...
- Identity framing: completed actions are evidence of who they're becoming. A missed stretch is a plan problem, not a character problem — respond by shrinking the action or moving its schedule, never by scolding.
